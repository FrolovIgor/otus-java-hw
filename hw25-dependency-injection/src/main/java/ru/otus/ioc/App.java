...
import ru.otus.ioc.appcontainer.AppComponentsContainerImpl;
import ru.otus.ioc.appcontainer.api.AppComponentsContainer;
import ru.otus.ioc.services.GameProcessor;
...
//         AppComponentsContainer container = new AppComponentsContainerImpl(AppConfig1.class, AppConfig2.class);
        ...
        // Тут можно использовать библиотеку Reflections (см. зависимости)
         AppComponentsContainer container = new AppComponentsContainerImpl("ru.otus.ioc.config.local");
